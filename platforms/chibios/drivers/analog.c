...
#if !RP_ADC_USE_ADC1 && !STM32_ADC_USE_ADC1 && !STM32_ADC_USE_ADC2 && !STM32_ADC_USE_ADC3 && !STM32_ADC_USE_ADC4 && !WB32_ADC_USE_ADC1 && !AT32_ADC_USE_ADC1 && !AT32_ADC_USE_ADC2 && !AT32_ADC_USE_ADC3
...
#    define USE_ADCV1
#elif defined(STM32F1XX) || defined(STM32F2XX) || defined(STM32F4XX) || defined(GD32VF103) || defined(WB32F3G71xx) || defined(WB32FQ95xx) || defined(AT32F405xx)
#    define USE_ADCV2
#endif
...
#ifndef ADC_COUNT
#    if defined(RP2040) || defined(STM32F0XX) || defined(STM32F1XX) || defined(STM32F4XX) || defined(GD32VF103) || defined(WB32F3G71xx) || defined(WB32FQ95xx) || defined(AT32F405xx)
#        define ADC_COUNT 1
...
#    if !defined(STM32F1XX) && !defined(GD32VF103) && !defined(WB32F3G71xx) && !defined(WB32FQ95xx)  && !defined(AT32F405xx)
    .cr2   = ADC_CR2_SWSTART, // F103 seem very unhappy with, F401 seems very unhappy without...
#    endif
#    if defined(AT32F405xx)
    .spt2 = ADC_SPT2_CSPT0(ADC_SAMPLING_RATE) | ADC_SPT2_CSPT1(ADC_SAMPLING_RATE) | ADC_SPT2_CSPT2(ADC_SAMPLING_RATE) | ADC_SPT2_CSPT3(ADC_SAMPLING_RATE) | ADC_SPT2_CSPT4(ADC_SAMPLING_RATE) | ADC_SPT2_CSPT5(ADC_SAMPLING_RATE) | ADC_SPT2_CSPT6(ADC_SAMPLING_RATE) | ADC_SPT2_CSPT7(ADC_SAMPLING_RATE) | ADC_SPT2_CSPT8(ADC_SAMPLING_RATE) | ADC_SPT2_CSPT9(ADC_SAMPLING_RATE),
    .spt1 = ADC_SPT1_CSPT10(ADC_SAMPLING_RATE) | ADC_SPT1_CSPT11(ADC_SAMPLING_RATE) | ADC_SPT1_CSPT12(ADC_SAMPLING_RATE) | ADC_SPT1_CSPT13(ADC_SAMPLING_RATE) | ADC_SPT1_CSPT14(ADC_SAMPLING_RATE) | ADC_SPT1_CSPT15(ADC_SAMPLING_RATE),
#    else
...
#    endif
#elif defined(STM32F1XX) || defined(GD32VF103) || defined(WB32F3G71xx) || defined(WB32FQ95xx) || defined(AT32F405xx)
        case A0:  return TO_MUX( ADC_CHANNEL_IN0,  0 );
        case A1:  return TO_MUX( ADC_CHANNEL_IN1,  0 );
        case A2:  return TO_MUX( ADC_CHANNEL_IN2,  0 );
        case A3:  return TO_MUX( ADC_CHANNEL_IN3,  0 );
